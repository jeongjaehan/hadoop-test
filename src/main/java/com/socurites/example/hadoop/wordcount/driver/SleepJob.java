...
implements Tool, Mapper<IntWritable, IntWritable, IntWritable, NullWritable>, Reducer<IntWritable, NullWritable, NullWritable, NullWritable>, Partitioner<IntWritable, NullWritable>
{
	...
	public void configure(JobConf job) {
		...
		this.reduceSleepDuration = (job.getLong("sleep.job.reduce.sleep.time", 100L) / this.reduceSleepCount);
	}
	...
	public int run(String[] args) throws Exception
	{
		...
		int numMapper = 1; int numReducer = 1;
		long mapSleepTime = 100L; long reduceSleepTime = 100L; long recSleepTime = 100L;
		int mapSleepCount = 1; int reduceSleepCount = 1;
	...
	implements InputFormat<IntWritable, IntWritable>
	{
		...
		public RecordReader<IntWritable, IntWritable> getRecordReader(InputSplit ignored, JobConf conf, Reporter reporter) throws IOException
		{
			...
			return new RecordReader<IntWritable,IntWritable>() {
				...
				public long getPos() throws IOException { return this.records; } 
				public void close() throws IOException {
				}
				public float getProgress() throws IOException { return this.records / count; }
			};
		}
	}
